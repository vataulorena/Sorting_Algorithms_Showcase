...
class IdleSessionActivityMonitor {
    ...
    static Run() {
        try {
            if (IdleSessionActivityMonitor.ParseAbtCookie()) {
            ...
            else if (IdleSessionActivityMonitor.IsIssoCookiePresent()) {
                ...
                IdleSessionActivityMonitor.GetInstance().InitializeWarningDialog();
    ...
    static IsIssoCookiePresent() {
        let result = false;
        try {
            let value = IdleSessionActivityMonitor.GetInstance().GetIssoCookieValue();
    ...
    InitializeSettingsFromCookie() {
        this.settings = new IssoPolicySettings(this.GetIssoCookieValue());
